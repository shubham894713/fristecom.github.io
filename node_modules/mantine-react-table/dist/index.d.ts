...
import { HTMLProps, MutableRefObject, Dispatch, SetStateAction, ReactNode } from 'react';
import { MantineSize, ActionIconProps, UnstyledButtonProps, TextInputProps, MultiSelectProps, SelectProps, BoxProps, CheckboxProps, ProgressProps, FlexProps, PaperProps, RadioProps, SkeletonProps, TableProps, ChipProps, AlertProps } from '@mantine/core';
 ...
 */
type HTMLPropsRef<T extends HTMLElement> = Omit<HTMLProps<T>, 'color' | 'size' | 'type' | 'ref'> & {
...
interface MRT_PaginationProps {
    rowsPerPageOptions?: string[];
    showFirstLastPageButtons?: boolean;
    showRowsPerPage?: boolean;
}
type MRT_DensityState = MantineSize;
...
type MRT_ColumnDef<TData extends Record<string, any> = {}> = Omit<ColumnDef<TData, unknown>, 'accessorKey' | 'aggregatedCell' | 'aggregationFn' | 'cell' | 'columns' | 'filterFn' | 'footer' | 'header' | 'id' | 'sortingFn'> & {
    ...
    mantineColumnActionsButtonProps?: (ActionIconProps & HTMLPropsRef<HTMLButtonElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        column: MRT_Column<TData>;
    }) => ActionIconProps & HTMLPropsRef<HTMLButtonElement>);
    mantineColumnDragHandleProps?: (ActionIconProps & HTMLPropsRef<HTMLButtonElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        column: MRT_Column<TData>;
    }) => ActionIconProps & HTMLPropsRef<HTMLButtonElement>);
    mantineCopyButtonProps?: (UnstyledButtonProps & HTMLPropsRef<HTMLButtonElement>) | ((props: {
        cell: MRT_Cell<TData>;
        column: MRT_Column<TData>;
        row: MRT_Row<TData>;
        table: MRT_TableInstance<TData>;
    }) => UnstyledButtonProps & HTMLPropsRef<HTMLButtonElement>);
    mantineEditTextInputProps?: (TextInputProps & HTMLPropsRef<HTMLInputElement>) | ((props: {
        cell: MRT_Cell<TData>;
        column: MRT_Column<TData>;
        row: MRT_Row<TData>;
        table: MRT_TableInstance<TData>;
    }) => TextInputProps & HTMLPropsRef<HTMLInputElement>);
    mantineFilterCheckboxProps?: (TextInputProps & HTMLPropsRef<HTMLInputElement>) | ((props: {
        column: MRT_Column<TData>;
        table: MRT_TableInstance<TData>;
    }) => TextInputProps & HTMLPropsRef<HTMLInputElement>);
    mantineFilterMultiSelectProps?: (Partial<MultiSelectProps> & HTMLPropsRef<HTMLInputElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        column: MRT_Column<TData>;
        rangeFilterIndex?: number;
    }) => Partial<MultiSelectProps> & HTMLPropsRef<HTMLInputElement>);
    mantineFilterSelectProps?: (Partial<SelectProps> & HTMLPropsRef<HTMLInputElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        column: MRT_Column<TData>;
        rangeFilterIndex?: number;
    }) => Partial<SelectProps> & HTMLPropsRef<HTMLInputElement>);
    mantineFilterTextInputProps?: (TextInputProps & HTMLPropsRef<HTMLInputElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        column: MRT_Column<TData>;
        rangeFilterIndex?: number;
    }) => TextInputProps & HTMLPropsRef<HTMLInputElement>);
    mantineTableBodyCellProps?: (BoxProps & HTMLPropsRef<HTMLTableCellElement> & ColumnAlignment) | ((props: {
        cell: MRT_Cell<TData>;
        column: MRT_Column<TData>;
        row: MRT_Row<TData>;
        table: MRT_TableInstance<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLTableCellElement> & ColumnAlignment);
    mantineTableFooterCellProps?: (BoxProps & HTMLPropsRef<HTMLTableCellElement> & ColumnAlignment) | ((props: {
        table: MRT_TableInstance<TData>;
        column: MRT_Column<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLTableCellElement> & ColumnAlignment);
    mantineTableHeadCellProps?: (BoxProps & HTMLPropsRef<HTMLTableCellElement> & ColumnAlignment) | ((props: {
        table: MRT_TableInstance<TData>;
        column: MRT_Column<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLTableCellElement> & ColumnAlignment);
 ...
 */
type MantineReactTableProps<TData extends Record<string, any> = {}> = Omit<Partial<TableOptions<TData>>, 'columns' | 'data' | 'defaultColumn' | 'enableRowSelection' | 'expandRowsFn' | 'getRowId' | 'globalFilterFn' | 'initialState' | 'onStateChange' | 'state'> & {
    columnFilterModeOptions?: Array<LiteralUnion<string & MRT_FilterOption>> | null;
    /**
    ...
    mantineBottomToolbarProps?: (BoxProps & HTMLPropsRef<HTMLDivElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    ...
    mantineDetailPanelProps?: (BoxProps & HTMLPropsRef<HTMLTableCellElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        row: MRT_Row<TData>;
    ...
    mantineExpandAllButtonProps?: (ActionIconProps & HTMLPropsRef<HTMLButtonElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => ActionIconProps & HTMLPropsRef<HTMLButtonElement>);
    mantineExpandButtonProps?: (ActionIconProps & HTMLPropsRef<HTMLButtonElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        row: MRT_Row<TData>;
    }) => ActionIconProps & HTMLPropsRef<HTMLButtonElement>);
    mantineFilterCheckboxProps?: (CheckboxProps & HTMLPropsRef<HTMLInputElement>) | ((props: {
        column: MRT_Column<TData>;
        table: MRT_TableInstance<TData>;
    ...
    mantineProgressProps?: (ProgressProps & HTMLPropsRef<HTMLDivElement>) | ((props: {
        isTopToolbar: boolean;
        table: MRT_TableInstance<TData>;
    }) => ProgressProps & HTMLPropsRef<HTMLDivElement>);
    mantinePaginationProps?: Partial<MRT_PaginationProps & FlexProps & HTMLPropsRef<HTMLDivElement>> | ((props: {
        table: MRT_TableInstance<TData>;
    }) => Partial<MRT_PaginationProps & FlexProps & HTMLPropsRef<HTMLDivElement>>);
    mantinePaperProps?: (PaperProps & HTMLPropsRef<HTMLDivElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => PaperProps & HTMLPropsRef<HTMLDivElement>);
    mantineRowDragHandleProps?: (ActionIconProps & HTMLPropsRef<HTMLButtonElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        row: MRT_Row<TData>;
    }) => ActionIconProps & HTMLPropsRef<HTMLButtonElement>);
    mantineSearchTextInputProps?: (TextInputProps & HTMLPropsRef<HTMLInputElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => TextInputProps & HTMLPropsRef<HTMLInputElement>);
    mantineSelectAllCheckboxProps?: (CheckboxProps & HTMLPropsRef<HTMLInputElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => CheckboxProps & HTMLPropsRef<HTMLInputElement>);
    mantineSelectCheckboxProps?: ((CheckboxProps | RadioProps) & HTMLPropsRef<HTMLInputElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        row: MRT_Row<TData>;
    }) => (CheckboxProps | RadioProps) & HTMLPropsRef<HTMLInputElement>);
    mantineSkeletonProps?: (SkeletonProps & HTMLPropsRef<HTMLDivElement>) | ((props: {
        cell: MRT_Cell<TData>;
        column: MRT_Column<TData>;
        row: MRT_Row<TData>;
        table: MRT_TableInstance<TData>;
    ...
    mantineTableBodyProps?: (BoxProps & HTMLPropsRef<HTMLTableSectionElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLTableSectionElement>);
    mantineTableBodyRowProps?: (BoxProps & HTMLPropsRef<HTMLTableRowElement>) | ((props: {
        isDetailPanel?: boolean;
        row: MRT_Row<TData>;
        table: MRT_TableInstance<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLTableRowElement>);
    mantineTableContainerProps?: (BoxProps & HTMLPropsRef<HTMLDivElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLDivElement>);
    mantineTableFooterCellProps?: (BoxProps & HTMLPropsRef<HTMLTableCellElement> & ColumnAlignment) | ((props: {
        table: MRT_TableInstance<TData>;
    ...
    mantineTableFooterProps?: (BoxProps & HTMLPropsRef<HTMLTableSectionElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLTableSectionElement>);
    mantineTableFooterRowProps?: (BoxProps & HTMLPropsRef<HTMLTableRowElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    ...
    mantineTableHeadProps?: (BoxProps & HTMLPropsRef<HTMLTableSectionElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLTableSectionElement>);
    mantineTableHeadRowProps?: (BoxProps & HTMLPropsRef<HTMLTableRowElement>) | ((props: {
        table: MRT_TableInstance<TData>;
        headerGroup: MRT_HeaderGroup<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLTableRowElement>);
    mantineTableProps?: (TableProps & HTMLPropsRef<HTMLTableElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => TableProps & HTMLPropsRef<HTMLTableElement>);
    mantineToolbarAlertBannerChipProps?: (Partial<ChipProps> & HTMLPropsRef<HTMLDivElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => Partial<ChipProps> & HTMLPropsRef<HTMLDivElement>);
    mantineToolbarAlertBannerProps?: (AlertProps & HTMLPropsRef<HTMLDivElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => AlertProps & HTMLPropsRef<HTMLDivElement>);
    mantineTopToolbarProps?: (BoxProps & HTMLPropsRef<HTMLDivElement>) | ((props: {
        table: MRT_TableInstance<TData>;
    }) => BoxProps & HTMLPropsRef<HTMLDivElement>);
    /**
...
declare const MRT_FilterOptionMenu: <TData extends Record<string, any> = {}>({ header, onSelect, table, }: Props$e<TData>) => JSX.Element;

interface Props$d<TData extends Record<string, any> = {}> {
    table: MRT_TableInstance<TData>;
}
declare const MRT_GlobalFilterTextInput: <TData extends Record<string, any> = {}>({ table, }: Props$d<TData>) => JSX.Element;

interface Props$c<TData extends Record<string, any> = {}> extends ActionIconProps, HTMLPropsRef<HTMLButtonElement> {
    table: MRT_TableInstance<TData>;
}
declare const MRT_ShowHideColumnsButton: <TData extends Record<string, any> = {}>({ table, ...rest }: Props$c<TData>) => JSX.Element;

interface Props$b<TData extends Record<string, any> = {}> {
    position?: 'top' | 'bottom';
    table: MRT_TableInstance<TData>;
}
declare const MRT_TablePagination: <TData extends Record<string, any> = {}>({ table, position, }: Props$b<TData>) => JSX.Element;

interface Props$a<TData extends Record<string, any> = {}> extends ActionIconProps, HTMLPropsRef<HTMLButtonElement> {
    table: MRT_TableInstance<TData>;
}
declare const MRT_ToggleFullScreenButton: <TData extends Record<string, any> = {}>({ table, ...rest }: Props$a<TData>) => JSX.Element;

interface Props$9<TData extends Record<string, any> = {}> extends ActionIconProps, HTMLPropsRef<HTMLButtonElement> {
    table: MRT_TableInstance<TData>;
}
declare const MRT_ToggleDensePaddingButton: <TData extends Record<string, any> = {}>({ table, ...rest }: Props$9<TData>) => JSX.Element;

interface Props$8<TData extends Record<string, any> = {}> extends ActionIconProps, HTMLPropsRef<HTMLButtonElement> {
    table: MRT_TableInstance<TData>;
}
declare const MRT_ToggleFiltersButton: <TData extends Record<string, any> = {}>({ table, ...rest }: Props$8<TData>) => JSX.Element;

interface Props$7<TData extends Record<string, any> = {}> extends ActionIconProps, HTMLPropsRef<HTMLButtonElement> {
    table: MRT_TableInstance<TData>;
}
declare const MRT_ToggleGlobalFilterButton: <TData extends Record<string, any> = {}>({ table, ...rest }: Props$7<TData>) => JSX.Element;
...
declare const MRT_ToggleRowActionMenuButton: <TData extends Record<string, any> = {}>({ cell, row, table, }: Props$6<TData>) => JSX.Element;
...
declare const MRT_ProgressBar: <TData extends Record<string, any> = {}>({ isTopToolbar, table, }: Props$2<TData>) => JSX.Element;
...
export { ColumnAlignment, HTMLPropsRef, MRT_AggregationFn, MRT_AggregationFns, MRT_AggregationOption, MRT_BottomToolbar, MRT_Cell, MRT_Column, MRT_ColumnDef, MRT_CopyButton, MRT_DefinedColumnDef, MRT_DensityState, MRT_DisplayColumnIds, MRT_FilterFn, MRT_FilterFns, MRT_FilterOption, MRT_FilterOptionMenu, MRT_GlobalFilterTextInput, MRT_Header, MRT_HeaderGroup, MRT_Icons, MRT_InternalFilterOption, MRT_Localization, MRT_PaginationProps, MRT_ProgressBar, MRT_Row, MRT_RowModel, MRT_ShowHideColumnsButton, MRT_SortingFn, MRT_SortingFns, MRT_SortingOption, MRT_TableInstance, MRT_TablePagination, MRT_TableState, MRT_ToggleDensePaddingButton, MRT_ToggleFiltersButton, MRT_ToggleFullScreenButton, MRT_ToggleGlobalFilterButton, MRT_ToggleRowActionMenuButton, MRT_ToolbarAlertBanner, MRT_ToolbarDropZone, MRT_ToolbarInternalButtons, MRT_TopToolbar, MantineReactTable, MantineReactTableProps, MantineShade };
