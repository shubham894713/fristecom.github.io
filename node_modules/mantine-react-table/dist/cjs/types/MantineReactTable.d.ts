import { Dispatch, HTMLProps, MutableRefObject, ReactNode, SetStateAction } from 'react';
import type { ActionIconProps, BoxProps, ProgressProps, AlertProps, CheckboxProps, ChipProps, PaperProps, RadioProps, SkeletonProps, TableProps, TextInputProps, MantineSize, UnstyledButtonProps, SelectProps, MultiSelectProps, FlexProps } from '@mantine/core';
 ...
 */
export type MantineReactTableProps<TData extends Record<string, any> = {}> = Omit<Partial<TableOptions<TData>>, 'columns' | 'data' | 'defaultColumn' | 'enableRowSelection' | 'expandRowsFn' | 'getRowId' | 'globalFilterFn' | 'initialState' | 'onStateChange' | 'state'> & {
    columnFilterModeOptions?: Array<LiteralUnion<string & MRT_FilterOption>> | null;
    /**
