...
/**
   ...
   *
   * @license MIT
   */var y="undefined"!=typeof window?o.useLayoutEffect:o.useEffect;function E(e){var t=o.useReducer((function(){return{}}),{})[1],n=r({},e,{onChange:function(n){t(),null==e.onChange||e.onChange(n)}}),i=o.useState((function(){return new b(n)}))[0];return i.setOptions(n),o.useEffect((function(){return i._didMount()}),[]),y((function(){return i._willUpdate()})),i}e.Virtualizer=b,e.approxEqual=u,e.defaultKeyExtractor=a,e.defaultRangeExtractor=c,e.elementScroll=p,e.measureElement=v,e.memo=s,e.notUndefined=l,e.observeElementOffset=h,e.observeElementRect=f,e.observeWindowOffset=m,e.observeWindowRect=d,e.useVirtualizer=function(e){return E(r({observeElementRect:f,observeElementOffset:h,scrollToFn:p},e))},e.useWindowVirtualizer=function(e){return E(r({getScrollElement:function(){return"undefined"!=typeof window?window:null},observeElementRect:d,observeElementOffset:m,scrollToFn:g},e))},e.windowScroll=g,Object.defineProperty(e,"__esModule",{value:!0})}));
